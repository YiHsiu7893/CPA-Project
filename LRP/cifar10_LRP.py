...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=4, in_chans=3, embed_dim=8):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=4, in_chans=3, num_classes=10, embed_dim=8, depth=6,
                 num_heads=2, mlp_ratio=4., qkv_bias=False, mlp_head=False, drop_rate=0., attn_drop_rate=0.):
        super().__init__()
...
def ViT_cifar10(pretrained = False, **kwargs):
    ...
    if pretrained:
        pretrained_weights_path = 'model_weight/model_weights_epoch_10.pt'
...
if __name__=="__main__":
    ...
    for epoch in range(EPOCHES):
        ...
        weight_path = os.path.join(weights_folder, f'model_weights_epoch_{epoch + 1}.pt')
