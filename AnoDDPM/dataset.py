...
def init_datasets(ROOT_DIR, args):
    ...
    testing_dataset_normal = MRIDataset(
            ROOT_DIR=f'{ROOT_DIR}DATASETS/Test_normal/', img_size=args['img_size'], random_slice=args['random_slice']
            )
    testing_dataset_abnormal = MRIDataset(
            ROOT_DIR=f'{ROOT_DIR}DATASETS/Test_opacity/', img_size=args['img_size'], random_slice=args['random_slice']
            )
    return training_dataset, testing_dataset_normal, testing_dataset_abnormal
...
def testing_dataset_loader(mri_dataset, args, shuffle=True):
