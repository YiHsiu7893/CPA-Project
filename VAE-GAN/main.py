...
for epoch in range(epochs):
  ...
  if not os.path.exists(discriminator_weights_folder):
      ...
      print("make dir")    
  weight_path = os.path.join(generator_weights_folder, f'generator_weights_{epoch + 1}.pth') 
  weight_path = os.path.join(discriminator_weights_folder, f'discriminator_weights_{epoch + 1}.pth') 
  torch.save(gen.state_dict(), 'generator_weights.pth')
  torch.save(discrim.state_dict(), 'discriminator_weights.pth')
